...
function getRestaurantData() {
    ...
    request.open('GET', allrestaurants, true); // replaces postman
...
//This function is to display the individual restaurants details whenever the user clicks on the thumbnail
